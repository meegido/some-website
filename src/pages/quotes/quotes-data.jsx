export const QUOTES = [
  {
    ...
    hastags: ['4daysweek', 'productivity'],
    fullText:
    ...
    tags: ['ProsperidadCompartida', 'ÉliteExtractiva'],
  },
  {
    author: 'Allen Holub',
    ...
    hastags: ['productivity', 'developers'],
    fullText:
